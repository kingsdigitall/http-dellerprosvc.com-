      ...
      <div className="item-center flex flex-col justify-around border px-10 py-10 md:flex-row md:py-20">
        <div className="md:w-[45%]">
          ...
          <div className="mt-2 text-5xl">
            Superior Roofing <span className="text-minor">Services</span> For
            All Your Needs
          </div>
          <div className="mt-2">
            Whether you need roof installation, maintenance, or repairs for
            residential or commercial properties, our expert solutions provide
            the ultimate protection for your home and loved ones.
          </div>
